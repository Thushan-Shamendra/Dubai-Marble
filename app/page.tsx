...
export default function HomePage() {
  return (
    <div className="bg-[#F7F9FC] text-[#1F2937]">
      {/* ─────────────────────────────────────────────────────────────
          1. HERO SECTION (Full Visibility Video Background with Glassmorphic Card)
         ───────────────────────────────────────────────────────────── */}
      <section className="relative min-h-[88vh] flex items-center overflow-hidden bg-[#10233F] border-b border-[#D9E2EC]">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#10233F]/95 via-[#10233F]/75 to-[#10233F]/50 pointer-events-none" />
        </div>
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-[46px] font-black leading-[1.18] mb-4 text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
                <span className="text-[#2F80ED] underline decoration-[#2F80ED] decoration-4 underline-offset-4">
                ...
                <span className="text-lg sm:text-xl font-bold text-[#EEF5FF] font-arabic mt-1 block leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
                  خدمات تلميع وصيانة الرخام في دبي للفنادق 5 نجوم والممتلكات الخاصة والعامة
                </span>
              </h1>

              <p className="text-[#E4E7EC] text-sm sm:text-base leading-relaxed max-w-xl mb-6 font-medium drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
              ...
              <div className="flex flex-wrap items-center gap-3.5 mb-7">
                <Link
                  href="/services"
                  className="bg-[#2F80ED] hover:bg-[#1557B0] active:bg-[#10233F] text-white font-bold text-sm px-7 py-3.5 rounded-xl shadow-lg transition-all flex items-center gap-2"
                >
                  Our Services · خدماتنا <ArrowRight className="w-4 h-4" />
                </Link>
                <a
                  href="tel:+971522774953"
                  className="bg-[#10233F]/70 hover:bg-[#1557B0]/60 border border-white/20 text-white px-6 py-3.5 rounded-xl font-bold text-sm transition-all flex items-center gap-2 shadow-md backdrop-blur-sm"
                >
                  <Phone className="w-4 h-4 text-[#2F80ED]" /> +971 52 277 4953
                </a>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm font-medium text-white">
                {[
                  ...
                  <div key={t.en} className="flex items-center gap-2 bg-[#102A56]/60 backdrop-blur-md px-3.5 py-2 rounded-xl border border-white/20 shadow-md">
                    <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                    <span>{t.en}</span>
                    <span className="text-[11px] text-[#2F80ED] font-arabic">({t.ar})</span>
                  </div>
                ))}
              </div>
            </motion.div>
      ...
      {/* ─────────────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────────────── */}
      <section className="relative py-16 sm:py-20 bg-white border-y border-[#D9E2EC] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <AnimatedSection direction="left" className="lg:col-span-7">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-[#10233F] mb-2 leading-tight">
                Delivering Quality, Reliability &amp; Complete Customer Satisfaction
              </h2>
              <div className="text-[#1557B0] font-bold font-arabic text-sm sm:text-base mb-4">
                تقديم الجودة والموثوقية ورضا العملاء الكامل في دبي والإمارات
              </div>

              <p className="text-[#667085] text-sm sm:text-base leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {[
                  ...
                  {
                    icon: <Wrench className="w-5 h-5 text-[#1557B0]" />,
                  ...
                  {
                    icon: <Award className="w-5 h-5 text-[#1557B0]" />,
                  ...
                  {
                    icon: <ShieldCheck className="w-5 h-5 text-[#1557B0]" />,
                  ...
                  <div key={title} className="p-4 rounded-xl bg-white border border-[#D9E2EC] flex gap-3.5 shadow-sm hover:border-[#1557B0]/40 transition-colors">
                    <div className="w-9 h-9 rounded-lg bg-[#EEF5FF] border border-[#D9E2EC] flex items-center justify-center shrink-0 mt-0.5">
                      {icon}
                    </div>
                    <div>
                      <div className="font-bold text-[#1F2937] text-sm">{title}</div>
                      <div className="text-[11px] text-[#1557B0] font-arabic font-semibold">{ar}</div>
                      <div className="text-xs text-[#667085] mt-1 leading-relaxed">{desc}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 bg-[#1557B0] hover:bg-[#10233F] text-white font-bold text-sm px-7 py-3.5 rounded-xl shadow transition-colors"
              >
                <span>More About Us</span>
                <span className="font-arabic font-normal border-l border-white/20 pl-2">المزيد عنا</span>
            ...
            <AnimatedSection direction="right" className="lg:col-span-5">
              <div className="relative">
                <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-xl border border-[#D9E2EC]">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#10233F]/90 via-transparent to-transparent" />
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="text-white font-bold text-lg">Italian Wet Diamond Honing</div>
                    <div className="text-[#2F80ED] text-xs font-semibold">100% Dustless · جلي بالألماس بدون غبار</div>
                  </div>
                </div>

                {/* Counter Card */}
                <div className="absolute -bottom-5 -left-5 sm:left-6 bg-[#10233F] text-white p-5 sm:p-6 rounded-2xl shadow-xl font-black text-center border border-white/15">
                  <div className="text-3xl sm:text-4xl leading-none text-[#2F80ED]">16+</div>
                  <div className="text-xs uppercase tracking-widest font-bold mt-1.5 text-[#D0D5DD]">Years of Experience</div>
                  <div className="text-[11px] font-arabic font-normal mt-0.5 text-[#98A2B3]">سنوات من الخبرة والتميز</div>
                </div>
              </div>
            </AnimatedSection>
          </div>
      ...
      {/* ─────────────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────────────── */}
      <section className="relative py-16 sm:py-20 bg-[#EEF5FF] border-y border-[#D9E2EC]">
        <SectionDivider type="peak-up" color="#EEF5FF" position="top" height={36} />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {servicesData.map((s, i) => (
              <AnimatedSection key={s.slug} delay={i * 0.05}>
                <Link
                  ...
                  className="group block bg-white rounded-2xl overflow-hidden border border-[#D9E2EC] shadow-sm hover:shadow-xl hover:border-[#1557B0]/40 hover:-translate-y-1 transition-all h-full flex flex-col"
                >
                  <div className="aspect-[16/10] relative overflow-hidden bg-[#EEF5FF]">
                    ...
                    <div className="absolute bottom-3 left-4 right-4">
                      <span className="text-[11px] font-bold text-white font-arabic bg-[#10233F]/85 backdrop-blur-sm px-2.5 py-0.5 rounded-md border border-white/20">
                        {s.arTitle}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="font-bold text-[#10233F] text-lg mb-1 group-hover:text-[#1557B0] transition-colors">
                      {s.title}
                    </h3>
                    <div className="text-xs text-[#1557B0] font-semibold font-arabic mb-3">
                      {s.arTitle}
                    </div>
                    <p className="text-[#667085] text-xs sm:text-sm leading-relaxed mb-5 line-clamp-2 flex-grow">
                      {s.description}
                    </p>
                    <div className="flex items-center justify-between pt-4 border-t border-[#D9E2EC] text-xs font-bold text-[#1557B0]">
          ...
          <div className="mt-10 p-6 rounded-2xl bg-white border border-[#D9E2EC] shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-center sm:text-left">
              <h4 className="text-base font-bold text-[#10233F]">Need a custom stone inspection or quote?</h4>
              <p className="text-xs text-[#667085]">Contact our technical team for immediate on-site consultation anywhere in Dubai.</p>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              <Link
                href="/booking"
                className="bg-[#2F80ED] hover:bg-[#1557B0] text-white font-bold text-xs sm:text-sm px-6 py-3 rounded-xl shadow transition-colors"
              >
                Schedule a Booking · احجز الآن
              </Link>
              <a
                href="tel:+971522774953"
                className="bg-[#F7F9FC] hover:bg-[#EEF5FF] text-[#10233F] font-bold text-xs sm:text-sm px-5 py-3 rounded-xl transition-all flex items-center gap-2 border border-[#D9E2EC]"
              >
                <Phone className="w-3.5 h-3.5 text-[#1557B0]" /> +971 52 277 4953
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-[#F7F9FC] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              {
                icon: <ShieldCheck className="w-6 h-6 text-[#1557B0]" />,
                title: "Fully Insured",
              ...
              {
                icon: <Award className="w-6 h-6 text-[#1557B0]" />,
              ...
              {
                icon: <Layers className="w-6 h-6 text-[#1557B0]" />,
              ...
              {
                icon: <CheckCircle2 className="w-6 h-6 text-[#1557B0]" />,
              ...
              {
                icon: <Sparkles className="w-6 h-6 text-[#1557B0]" />,
              ...
              {
                icon: <Search className="w-6 h-6 text-[#1557B0]" />,
              ...
              {
                icon: <MapPin className="w-6 h-6 text-[#1557B0]" />,
                title: "Locally Owned",
              ...
              {
                icon: <FileText className="w-6 h-6 text-[#1557B0]" />,
              ...
              <AnimatedSection key={title} delay={i * 0.04}>
                <div className="p-6 rounded-2xl bg-white border border-[#D9E2EC] hover:border-[#1557B0]/40 hover:shadow-md transition-all h-full flex flex-col">
                  <div className="w-12 h-12 rounded-xl bg-[#EEF5FF] border border-[#D9E2EC] shadow-sm flex items-center justify-center mb-4">
                    {icon}
                  </div>
                  <h3 className="font-bold text-[#10233F] text-base mb-0.5">{title}</h3>
                  <div className="text-[11px] text-[#1557B0] font-arabic font-semibold mb-2">{ar}</div>
                  <p className="text-xs text-[#667085] leading-relaxed flex-grow">{desc}</p>
                </div>
              </AnimatedSection>
            ))}
          </div>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/booking"
              className="bg-[#2F80ED] hover:bg-[#1557B0] text-white font-bold text-sm px-8 py-3.5 rounded-xl shadow transition-colors"
            >
              Schedule a Booking · احجز الآن
            </Link>
            <a
              href="tel:+971522774953"
              className="bg-white border border-[#D9E2EC] text-[#10233F] hover:border-[#1557B0] px-6 py-3.5 rounded-xl font-bold text-sm transition-all flex items-center gap-2 shadow-sm"
            >
              <Phone className="w-4 h-4 text-[#1557B0]" /> +971 52 277 4953
            </a>
          </div>
        </div>
      </section>
      ...
      {/* ─────────────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────────────── */}
      <section className="relative py-16 sm:py-20 bg-white text-[#1F2937] border-y border-[#D9E2EC]">
        <SectionDivider type="peak-up" color="#FFFFFF" position="top" height={36} />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-12">
            <SectionLabel variant="minimal" arabic="معرض المشاريع">OUR PROJECTS</SectionLabel>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black mb-2 text-[#10233F]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <AnimatedSection key={p.title} delay={idx * 0.06}>
                <div className="group relative aspect-square rounded-2xl overflow-hidden border border-[#D9E2EC] bg-[#F7F9FC] shadow-sm hover:shadow-lg transition-all">
                  <Image
                    src={p.src}
                    alt={p.title}
                    fill
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#10233F]/90 via-[#10233F]/30 to-transparent opacity-85 group-hover:opacity-95 transition-opacity" />
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="text-xs text-[#2F80ED] font-bold uppercase tracking-wider mb-0.5">{p.location}</div>
          ...
          <div className="mt-10 text-center flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/gallery"
              className="bg-[#1557B0] hover:bg-[#10233F] text-white font-bold text-sm px-8 py-3.5 rounded-xl shadow transition-colors"
            >
              View All Projects · كافة المشاريع
            </Link>
            <a
              href="tel:+971522774953"
              className="bg-[#F7F9FC] border border-[#D9E2EC] text-[#10233F] hover:border-[#1557B0] px-6 py-3.5 rounded-xl font-bold text-sm transition-all flex items-center gap-2 shadow-sm"
            >
              <Phone className="w-4 h-4 text-[#1557B0]" /> +971 52 277 4953
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
            {[
              ...
              <AnimatedSection key={step} delay={i * 0.08}>
                <div className="relative p-8 rounded-3xl bg-white border border-[#D9E2EC] shadow-sm hover:shadow-md transition-all h-full flex flex-col">
                  {/* Step Ribbon */}
                  <div className="absolute top-0 right-8 -translate-y-1/2 bg-[#1557B0] text-white text-xs font-bold px-4 py-1 rounded-full shadow-sm">
                    {step}
                  </div>

                  <div className="w-12 h-12 rounded-2xl bg-[#EEF5FF] border border-[#D9E2EC] shadow-sm flex items-center justify-center mb-6">
                    {icon}
                  </div>
                  <h3 className="font-extrabold text-[#10233F] text-xl mb-1">{title}</h3>
                  <div className="text-xs text-[#1557B0] font-arabic font-semibold mb-3">{ar}</div>
                  <p className="text-[#667085] text-sm leading-relaxed flex-grow">{desc}</p>
                </div>
              </AnimatedSection>
            ))}
          </div>
      ...
      {/* ─────────────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────────────── */}
      <section className="relative py-20 sm:py-24 overflow-hidden bg-[#10233F] border-y border-white/10">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-[#10233F]/90 backdrop-blur-[2px]" />
        </div>

        <SectionDivider type="peak-up" color="#10233F" position="top" height={36} />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-2xl mx-auto mb-12">
            ...
            <div className="text-[#EEF5FF] font-arabic font-bold text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <AnimatedSection key={t.name} delay={idx * 0.08}>
                <div className="p-7 rounded-2xl bg-white border border-[#D9E2EC] shadow-md hover:shadow-xl hover:-translate-y-1 transition-all h-full flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Quote className="w-6 h-6 text-[#98A2B3]" />
                    </div>

                    <p className="text-[#1F2937] text-xs sm:text-sm leading-relaxed mb-4">
                      &ldquo;{t.text}&rdquo;
                    </p>
                    <p className="text-[#667085] text-xs font-arabic leading-relaxed mb-6 border-t border-[#D9E2EC] pt-3">
                      {t.arText}
                    </p>
                  </div>

                  <div className="flex items-center gap-3 pt-3 border-t border-[#D9E2EC]">
                    <div className="w-10 h-10 rounded-full bg-[#EEF5FF] text-[#1557B0] flex items-center justify-center font-bold text-sm shrink-0">
                      {t.name.charAt(0)}
                    </div>
                    <div>
                      <div className="font-bold text-[#10233F] text-sm">{t.name}</div>
                      <div className="text-[11px] text-[#667085]">{t.location} <span className="text-[#1557B0] font-arabic font-semibold">({t.arRole})</span></div>
                    </div>
                  </div>
                </div>
              </AnimatedSection>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {otherServices.map((svc, i) => (
              <AnimatedSection key={svc.title} delay={i * 0.04}>
                <div className="group bg-white rounded-2xl overflow-hidden border border-[#D9E2EC] shadow-sm hover:shadow-md transition-all h-full flex flex-col">
                  <div className="aspect-[16/10] relative overflow-hidden bg-[#EEF5FF]">
                    <Image
                      src={svc.image}
                      alt={svc.title}
                    ...
                    <div className="absolute bottom-2 left-3 right-3 text-[11px] font-bold text-white font-arabic">
                      {svc.ar}
                    </div>
                  </div>

                  <div className="p-5 flex flex-col flex-grow">
                    <h3 className="font-bold text-[#10233F] text-base mb-2 group-hover:text-[#1557B0] transition-colors">
                      {svc.title}
                    </h3>
                    <p className="text-xs text-[#667085] leading-relaxed mb-4 flex-grow">
                      {svc.desc}
                    </p>
                    <Link
                      href={svc.link}
                      className="inline-flex items-center gap-1 text-xs font-bold text-[#1557B0] hover:text-[#2F80ED] transition-colors"
                    >
      ...
      {/* ─────────────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────────────── */}
      <section className="py-16 sm:py-20 bg-[#EEF5FF] border-y border-[#D9E2EC] relative overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-8">
            ...
            <div className="text-[#1557B0] font-arabic font-bold text-sm sm:text-base">
      ...
      <section className="py-16 sm:py-20 bg-[#F7F9FC] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {blogArticles.map((b, i) => (
              <AnimatedSection key={b.title} delay={i * 0.08}>
                <div className="group bg-white rounded-2xl overflow-hidden border border-[#D9E2EC] shadow-sm hover:shadow-md transition-all h-full flex flex-col">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <div className="flex items-center gap-2 text-xs text-[#98A2B3] mb-2.5">
                      <Calendar className="w-3.5 h-3.5 text-[#1557B0]" />
                      <span>{b.date}</span>
                    </div>

                    <h3 className="font-bold text-[#10233F] text-base mb-2 group-hover:text-[#1557B0] transition-colors leading-snug">
                      {b.title}
                    </h3>
                    <div className="text-xs text-[#1557B0] font-arabic font-semibold mb-4">
                      {b.ar}
                    </div>

                    <div className="mt-auto pt-3 border-t border-[#D9E2EC]">
                      <Link
                        href={b.link}
                        className="inline-flex items-center gap-1 text-xs font-bold text-[#1557B0] hover:text-[#2F80ED] transition-colors"
                      >
          ...
          <div className="mt-10 text-center">
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 bg-[#1557B0] hover:bg-[#10233F] text-white font-bold text-sm px-8 py-3.5 rounded-xl shadow transition-colors"
            >
              <span>View All Articles</span>
              <span className="font-arabic font-normal border-l border-white/20 pl-2">كافة المقالات</span>
              <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
